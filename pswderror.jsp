...
<font color="#ffffff" size="10" face="Blurry"> Facebook</font> 
 ...
 <img src="images/xyz.jpg" width="40" height="40">${fname} ${lname} <br> ${email }</div>

 
 <input type="hidden" id="txtusername" name="uname" value=${email }>
  
 <div class="row">
 <div class="col-xs-12 col-lg-12 col-md-2"></div>
 <div class="col-xs-12 col-lg-12 col-md-4"></div>
 <div class="col-xs-12 col-lg-12 col-md-6">
 <a href="">Not ${fname} ? </a> 
 </div>
 ...
 <input type="password"  id="txtpassword"  name="pswd" data-toggle="tooltip" data-placement="right" title= "The password that you've entered  is incorrect  Forgotten password"></div>
 </div> <br>
 <div class="row">
